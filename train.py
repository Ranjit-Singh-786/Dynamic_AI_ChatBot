...
def Train_the_model():
    try:
        ...
        model_file_path =LSTM_Model_artifact.lstm_model_file_path
...
if __name__=="__main__":
    model_file_path = Train_the_model()
    print(f"saved your trained model at this location :- {model_file_path}")
