...
class Training_Pipeline:
    ...
    def Train_the_model(self):
        try:
            ...
            transformed_dict_file_path = LSTM_Model_artifact.transformed_dict_file_path
            # Bert_Model_trainer_artifact = Model_trainer_obj.Initiate_Bert_model()
            return lstm_model_file_path,max_sequence_length,label_tag_dict_file_path,transformed_dict_file_path
